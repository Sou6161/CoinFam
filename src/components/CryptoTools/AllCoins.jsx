  ...
  return (
    <>
      ...
      <div className="bg-[#0f172a] pb-16">
        ...
        <div className=" bg-[#0f172a] min-h-screen text-yellow-400 mt-[14vh] px-2 ">
            ...
            <table className="min-w-full bg-slate-900/40 rounded-lg">
              <thead className="bg-teal-900">
                <tr>
                  ...
                  <th className="px-4 py-2 xsmall:px-6 xsmall:py-4 max-w-[25vw] whitespace-nowrap xsmall:max-w-[30vw] bg-purple-400/50 backdrop-blur-md text-left text-xs font-semibold text-white uppercase tracking-wider">
                    Total Vol
                  </th>
